...
public:
    ...
    virtual Table instantiate(const ActionSchema &action, const DBState &state,
            const Task &task, DynamicState &thesis, std::vector<std::vector<DynamicTables>> &thesis_tables, std::vector<std::vector<DynamicTables>> &thesis_semijoin, DBState &old_state, bool enable);
    ...
    */
    ...
    DBState generate_successor(const LiftedOperatorId &op,
                               ...
                               const DBState &state,
                                DynamicState *thesis_class) override;
    ...
    std::vector<LiftedOperatorId> get_applicable_actions(
            ...
            std::vector<std::vector<DynamicTables>> &thesis_tables, std::vector<std::vector<DynamicTables>> &thesis_semijoin, DBState &old_state, bool enable) override;
...
protected:
    ...
    static void filter_static(const ActionSchema &action, Table &working_table, DynamicTables &save) ;
