...
bool SearchBase::check_goal(const Task &task,
    ...
    print_goal_found(generator, timer_start, succgen, succgen_max);
...
template bool SearchBase::check_goal<SparsePackedState>(
        const Task &task, const SuccessorGenerator &generator, std::chrono::milliseconds::rep& timer_start, std::chrono::milliseconds::rep& succgen, std::chrono::milliseconds::rep& succgen_max,
